...
public class DateChooserJButton extends JButton {
    ...
    private class DateChooser extends JPanel implements ActionListener, ChangeListener {
        ...
        private JPanel createYearAndMonthPanal() {
            ...
            yearSpin.setPreferredSize( new Dimension( 50 , 50 ));
            ...
            monthSpin.setPreferredSize( new Dimension( 50 , 50 ));
            ...
            daySpin.setPreferredSize( new Dimension( 50 , 50 ));
            daySpin.setName( "Day" );
            ...
            hourSpin.setPreferredSize( new Dimension( 50 , 50 ));
            ...
            minuteSpin.setPreferredSize( new Dimension( 50 , 50 ));
            ...
            secondSpin.setPreferredSize( new Dimension( 50 , 50 ));
